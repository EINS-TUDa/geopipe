...
def test_district_from_bounding_box():
    region = gpd.read_file(Path("data/projects/bensheim/wah_bensheim_4_districts.geojson"))
...
def test_residential_yearly_heat_demand():
    region = gpd.read_file(Path("data/projects/bensheim/baublock_bensheim_epsg25832.geojson"))
