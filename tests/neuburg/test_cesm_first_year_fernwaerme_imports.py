...
def first_year_imports_t(tmp_path: Path) -> None:
    ...
    polygon_path = REPO_ROOT / "examples" / "neuburg" / "polygon_neuburg.geojson"
    street_segments_path = REPO_ROOT / "examples" / "neuburg" / "street_segments_neuburg.geojson"
    heating_shares_path = REPO_ROOT / "examples" / "neuburg" / "heating_shares_neuburg.geojson"
